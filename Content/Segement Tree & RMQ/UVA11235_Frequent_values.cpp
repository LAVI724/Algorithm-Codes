...
https://theriseofdavid.github.io/2021/03/06/Explain_Algorithm/segment-tree/

參考資料:
https://theriseofdavid.github.io/2021/03/04/UVa/UVa11235/
http://naivered.github.io/2018/05/20/Problem_Solving/UVa/UVa-11235-Frequent-values/
...
int main(){
    ...
    while(cin >> n && n){
        ...
        // for(int i = 1; i <= n; ++i){
        //     cout << num[i].value << " " << num[i].lef << " " << num[i].rig << " " << num[i].fre << endl;
        // }

        build(1, n, 1);

        // for(int i = 1; i <= 20; ++i){
        //     cout << tree[i].lef << " " << tree[i].rig << " " << tree[i].value << endl;
        // }
